...
| Alma Linux 9                | `AlmaLinux`        | `9.8`          | `amd64`      | // EOL: 31 May 2032
| Alma Linux 10               | `AlmaLinux`        | `10.2`         | `amd64`      | // EOL: 31 May 2035
| Alpine 3.21                 | `Alpine`           | `3.21.7`       | `amd64`      | // EOL: 01 Nov 2026
| Alpine 3.22                 | `Alpine`           | `3.22.5`       | `amd64`      | // EOL: 01 May 2027
| Alpine 3.23                 | `Alpine`           | `3.23.5`       | `amd64`      | // EOL: 01 Nov 2027
| Alpine 3.24                 | `Alpine`           | `3.24.1`       | `amd64`      | // EOL: 01 May 2028
...
| FreeBSD 15                  | `freebsd`          | `15.1-RELEASE` | `amd64`      | // EOL: 31 Mar 2027
| openSUSE Leap               | `openSUSE`         | `16.0`         | `amd64`      | // EOL: 31 Oct 2027
| Oracle Linux 8              | `OracleServer`     | `8.10`         | `amd64`      | // EOL: 31 May 2029
| Oracle Linux 9              | `OracleServer`     | `9.8`          | `amd64`      | // EOL: 31 May 2032
| Oracle Linux 10             | `OracleServer`     | `10.2`         | `amd64`      | // EOL: 31 May 2035
...
| Red Hat Enterprise Linux 10 | `RedHatEnterprise` | `10.2`         | `amd64`      | // EOL: 31 May 2035
| Rocky Linux 8               | `Rocky`            | `8.10`         | `amd64`      | // EOL: 31 May 2029
| Rocky Linux 9               | `Rocky`            | `9.8`          | `amd64`      | // EOL: 31 May 2032
| Rocky Linux 10              | `Rocky`            | `10.2`         | `amd64`      | // EOL: 31 May 2035
