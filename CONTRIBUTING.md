...
The Dockerfile tags are tracked by Renovate so that Docker image updates result in automated pull requests for the Docker image tags.

## Reporting Issues

Report issues in the [issue tracker](https://github.com/jenkinsci/platformlabeler-plugin/issues/new/choose).
