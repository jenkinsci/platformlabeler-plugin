...
public class PlatformDetailsTaskStaticStringTest {
    ...
    /**
     * Generate test parameters for cases which can be tested with static string conversions. Linux platform labeling
     * can't be tested with static string conversions. Refer to other tests for Linux platform labeling tests. Expected
     * values are computed in the test contructor.
     *
    ...
    public void testComputeLabels() throws Exception {
        ...
        assertThat(result,
                containsInAnyOrder(expectedArch, expectedName, expectedVersion, expectedArch + "-" + expectedName,
