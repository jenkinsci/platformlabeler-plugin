...
args=$@
all_files=$(find * -type f -name Dockerfile ! -path '*amzn/2022*' ! -path '*clearlinux*' ! -path '*tumbleweed*' ! -path '*almalinux/9*' ) # No lsb_release on clearlinux or Alma Linux, lsb_release empty on tumbleweed
